...
3. Open it in Unity 6
4. Import the controller prefab into your scene:
   - Go to `Assets/Player/Prefab/Player`
   - Drag it into your scene
5. Make sure you have a Main Camera in the scene
6. Press Play and start testing in either view mode!
...
Pull requests are welcome! If you find bugs or have feature suggestions, feel free to [open an issue](https://github.com/chuss1/Unity-Character/issues).
